-- Script para crear evaluación usando subject_selection_id en lugar de position_selection_id
-- Ejecutar en Supabase Dashboard -> SQL Editor

-- Primero, verificar si hay subject_selection_id para esta inscripción
SELECT 
    'Subject Selections for ISAAC' as info,
...
-- Si no hay subject_selection_id, crear uno primero
-- (Esto es solo para verificar, no ejecutar aún)
-- INSERT INTO inscription_subject_selections (inscription_id, subject_id, position_type)
-- VALUES ('1a958c32-f407-4f6d-b75d-b3eb73ca9869', (SELECT id FROM subjects WHERE name = 'INGLÉS' LIMIT 1), 'subject');

-- Crear evaluación con subject_selection_id (usando el patrón de la evaluación existente)
...
VALUES (
    ...
    (SELECT iss.id FROM inscription_subject_selections iss WHERE iss.inscription_id = '1a958c32-f407-4f6d-b75d-b3eb73ca9869' LIMIT 1),  -- subject_selection_id
    9.00,  -- titulo_score
