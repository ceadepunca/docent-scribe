-- Script para crear evaluación usando el patrón correcto de la restricción
-- Ejecutar en Supabase Dashboard -> SQL Editor

-- Crear evaluación con solo position_selection_id (sin subject_selection_id)
-- Usando el mismo patrón que las evaluaciones existentes
